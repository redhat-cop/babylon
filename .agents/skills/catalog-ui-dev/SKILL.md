...
Development guide for the Babylon catalog React UI in `catalog/ui/`. Intended for humans and AI coding assistants.
...
- For PF coding standards, imports, structure audits, and unit tests, use the **react** plugin from [patternfly/ai-helpers](https://github.com/patternfly/ai-helpers) after local install (see [AGENTS.md](../../../AGENTS.md#patternfly-ai-helpers-install-locally))
