...
const EventPurposeOpts = [
  { name: 'RHTE APAC', activity: 'Event', id: 1, sfdc: null },
  { name: 'RHTE EMEA', activity: 'Event', id: 2, sfdc: null },
  { name: 'RHTE LATAM', activity: 'Event', id: 3, sfdc: null },
  { name: 'RHTE NA', activity: 'Event', id: 4, sfdc: null },
];
