...
const WorkshopLogin: React.FunctionComponent<WorkshopLoginProps> = ({
  loginFailureMessage,
  onLogin,
  workshop,
}) => {
            ...
            <Form className="workshop-login-form">
              ...
              { workshop.accessPasswordRequired ? (
                <FormGroup
                  ...
                  labelIcon={
                    <Popover
                      bodyContent={
                        "Access password will be provided by your workshop facilitator."
                      }
                      headerContent={
                        "Access Password"
                      }
              ...
              <ActionGroup>
                <Button
                  ...
                  onClick={() => onLogin(email, accessPassword)}
                >Login</Button>
              </ActionGroup>
              { loginFailureMessage ? (
                <Text className="workshop-login-failure">{loginFailureMessage}</Text>
              ) : null }
            </Form>
          </Bullseye>
        </StackItem>
