...
const WorkshopHeader: React.FC<{ userInterface: string }> = ({ userInterface }) => {
  function LogoImg() {
    if (userInterface === 'summit') {
      return (
        <button
          ...
          style={{ display: 'flex', width: '70px', border: 0, backgroundColor: 'transparent', cursor: 'pointer' }}
        >
    ...
    return (
      <a href="https://demo.redhat.com" title="Red Hat Demo Platform" style={{ display: 'flex' }}>
  ...
  return (
    <header className="workshop-header">
      <div className="workshop-header__inner">
        <div className="workshop-header__brand">
          <LogoImg />
        </div>
        {userInterface === 'summit' ? (
          <div className="workshop-header__right">
            <a href="https://redhat.com/" style={{ width: '138px', display: 'flex' }}>
