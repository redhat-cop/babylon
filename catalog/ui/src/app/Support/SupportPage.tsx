...
const SupportPage: React.FC<{ title: string }> = ({ title }) => {
  ...
  const resolutionTimeForRHPD = createRowFromArr('Resolution Time');
        ...
        <div className="page-container">
          ...
          <Sidebar hasGutter style={{ height: 'auto' }}>
            <SidebarPanel style={{ marginTop: 'auto', marginBottom: 'auto' }}>
              ...
              >
                <em>
                  ...
                  set up in the past. With RHPD support we were able to focus on running the workshop and not on the
            ...
            <SidebarContent>
              <PageSection>
                ...
                <Text>
                  RHPD (Red Hat Platform Demo) helps you confidently plan and host customer-facing events with
          ...
          <PageSection style={{ paddingBottom: 'var(--pf-global--spacer--4xl)' }}>
            ...
            <Text component={TextVariants.p} style={{ padding: 'var(--pf-global--spacer--md)' }}>
              ...
              for more information about RHPD Solution Support.
            </Text>
            <Divider />
            <TextList
              component={TextListVariants.ul}
