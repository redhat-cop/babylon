...
const WorkshopCard: React.FC<WorkshopCardProps> = ({ asset, isAvailable, numberSeats }) => {
  ...
  return (
    ...
    >
      ...
      <div className="demo-card__body">
        ...
        {numberSeats != null && asset.type !== 'external' && (
          <p className="demo-card__seats">
            ...
            {numberSeats} {numberSeats === 1 ? 'seat' : 'seats'} available
          </p>
        )}
            ...
            {assets.map((asset, index) => {
              ...
              return (
                <WorkshopCard
                  ...
                  numberSeats={multiworkshop.spec.numberSeats}
                />
              );
            })}
          </div>
