                        ...
                        <DescriptionListDescription>
                          ...
                          <OpenshiftConsoleLink
                            reference={{
                              ...
                              kind: 'CatalogItem',
                              name: resourceClaim?.metadata.labels?.[`${BABYLON_ANNOTATION}/catalogItemName`],
                              namespace: resourceClaim?.metadata.labels?.[`${BABYLON_ANNOTATION}/catalogItemNamespace`],
                            }}
                          />
                        </DescriptionListDescription>
                      </DescriptionListGroup>
                    ) : null}
                    {resourceClaim?.metadata.annotations?.[`${BABYLON_ANNOTATION}/externalPlatformUrl`] ? (
                      <DescriptionListGroup>
                        <DescriptionListTerm>Managed By</DescriptionListTerm>
                        <DescriptionListDescription>
                          <a
                            href={resourceClaim?.metadata.annotations?.[`${BABYLON_ANNOTATION}/externalPlatformUrl`]}
                            target="_blank"
                            rel="noreferrer"
                          >
                            {resourceClaim?.metadata.annotations?.[`${BABYLON_ANNOTATION}/externalPlatformUrl`]}
