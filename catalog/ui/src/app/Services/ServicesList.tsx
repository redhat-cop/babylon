...
import { checkResourceClaimCanStart, checkResourceClaimCanStop, displayName, BABYLON_ANNOTATION } from '@app/util';
...
const ServicesList: React.FunctionComponent<ServicesListProps> = ({ serviceNamespaceName }) => {
