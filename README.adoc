...
* link:https://github.com/redhat-gpte-devopsautomation/poolboy.git[Poolboy - OpenShift Operator for Resource Pool Management]
...
* link:https://github.com/redhat-gpte-devopsautomation/poolboy.git[Poolboy - OpenShift Operator to manage OpenShift resources]
